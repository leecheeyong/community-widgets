        ...
        <div class="text-center mb-16 animate-fade-in mt-16">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="w-full lg:w-auto px-6 py-4 rounded-xl bg-black text-white font-semibold shadow hover:bg-gray-800 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2"
            >
